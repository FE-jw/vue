<template>
	<div class="pop-wrap" @click="evt => { evt.target.className == 'pop-wrap' ? popStore.close() : null }">
		<div class="pop-layer">
			<p class="pop-txt">{{ popStore.popTxt }}</p>
			<button type="button" class="btn-close" @click="popStore.close">닫기</button>
		</div>
	</div>
</template>
